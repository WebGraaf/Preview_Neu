...
export const SplitMediaText1zu1invert: React.FC<SplitMediaText1zu1invertProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div ref={imageRef} className="md:w-1/2 aspect-square group overflow-hidden">
          <img
            src={imageSrc}
            alt={imageAlt}
            className="w-full h-full object-cover rounded-t-2xl md:rounded-t-none md:rounded-r-2xl shadow-lg transition-all duration-500 group-hover:scale-105 group-hover:shadow-xl"
            loading="lazy"
          />
        </div>
